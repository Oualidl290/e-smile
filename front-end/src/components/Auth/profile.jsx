...
const Profile = ({ user }) => {
    ...
    return (
        <>
        <div className="flex flex-row justify-center w-full mt-20 text-2xl text-slate-600 font-abc font-bold"><p>Profile</p></div>
        <div className='w-full flex flex-row justify-center items-center'>
              <div className="overflow-hidden rounded-[20px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card mt-4 max-phone:w-[90%] max-phone:h-[500px] max-phone:gap-4 w-[50%] h-[500px] gap-4 shadow-2xl">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto mb-5.5 mt-5 grid max-w-[370px] grid-cols-3 rounded-[5px] border border-stroke py-[9px] shadow-1 dark:border-dark-3 dark:bg-dark-2 dark:shadow-card">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-dark-3 xsm:flex-row">
                ...
                <span className="text-body-sm">Saved</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-dark-3 xsm:flex-row">
                <span className="font-medium text-dark dark:text-white">
                  129K
                </span>
                <span className="text-body-sm">Views</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                <span className="font-medium text-dark dark:text-white">
                  2K
                </span>
                <span className="text-body-sm-sm">Order</span>
              </div>
            </div>
